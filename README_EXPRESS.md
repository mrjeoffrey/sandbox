...
@(devNotes)[express.js, nodemon, middleware]
...
| Question | Answer |
| :-- | :-- | 
| What is this used for? | This `node package` is used to setup server on the back-end using Javascript. It can handle routing for APIs, static pages, and authentication. |
| How frequently is it used? | Frequently used |
| Jobs related to knowing this? | Back-end Developer, Node.JS Developer, Express.JS Developer |
...
# III. Video Notes
The notes below are for [Express JS Cash Course](https://www.youtube.com/watch?v=L72fhGm1tfE)
...
## 3. With Middleware we can create our own APIs
**TO BE CONTINUED**
...
### A. Express.js and Express Servers
- [Express.js crash course](https://www.youtube.com/watch?v=L72fhGm1tfE) 
- [Express.js Tutorial](https://www.youtube.com/watch?v=pKd0Rpw7O48)
- [Beginner’s Guide to Understanding Node.js & Express.js Fundamentals](https://medium.com/@LindaVivah/the-beginners-guide-understanding-node-js-express-js-fundamentals-e15493462be1)

### B. HTTP Requests
- [What Are HTTP Requests?](https://rapidapi.com/blog/api-glossary/http-request-methods/)
- [Anatomy of an HTTP Transaction](https://nodejs.org/es/docs/guides/anatomy-of-an-http-transaction/)

### C. Routing
- [Node.js tutorial](https://www.geeksforgeeks.org/routing-in-node-js/)
...
- [Guide to using middleware](https://expressjs.com/en/guide/using-middleware.html)

### E. Separation of Concerns
- [Separation of Concerns explanation](https://medium.com/machine-words/separation-of-concerns-1d735b703a60)
- [Good practices for Node.js](https://blog.codeminer42.com/nodejs-and-good-practices-354e7d763626/)
